		 ...
		 switch(ch)
		  {
		    case 1:
				...
				do{
				System.out.println("*** NOTE: The key follows \'Use and Forget\' technology. No need for storage. ***\n");
		    ...
		    case 2: 
				...
				System.out.println("\t\t *** Encrypted-Key Size must be >500 with only contain Numeric Values! ***");
